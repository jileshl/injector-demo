...
public class DexUtils {
	...
	public static void prepareDex(Context context, File dexInternalStoragePath, String secondaryDexName) {
		try {
			prepareDex(context, dexInternalStoragePath, context.getAssets().open(secondaryDexName));
		} catch (Exception e) {
			e.printStackTrace();
		}
	 ...
	 * @param file 					 secondaryDexName asset file name
	 */
	public static void prepareDex(Context context, File dexInternalStoragePath, InputStream file) {
